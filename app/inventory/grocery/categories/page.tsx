...
import type { GroceryCategory } from "@/lib/types/grocery";

interface CategoryRow extends GroceryCategory {
  productCount: number;
}

export default function GroceryCategoriesPage() {
  const { categories, products, addCategory, updateCategory, deleteCategory } = useGroceryData();
  const { showToast } = useToast();

  const [search, setSearch] = useState("");
  const [editTarget, setEditTarget] = useState<GroceryCategory | "new" | null>(null);
  ...
  function openEdit(category: GroceryCategory) {
