...
export default function MedicalPurchasesPage() {
  const { purchases, suppliers, medicines, addPurchase } = useMedicalData();
  ...
  return (
    <div>
      <PageHeader
        title="Purchases"
        description={`${purchases.length} purchase orders from your suppliers`}
        actions={
      ...
      <FormPanel
        ...
        description="Log a new purchase order from a supplier."
        footer={
          <>
