...
function toFormState(vendor?: ElectronicsVendor): FormState {
  return {
    name: vendor?.name ?? "",
...
interface VendorFormProps {
  formId: string;
  initialVendor?: ElectronicsVendor;
    ...
    <form id={formId} onSubmit={handleSubmit} className="space-y-4" noValidate>
      <div>
        ...
        <input
          ...
          placeholder="e.g. Ingram Micro Electronics"
        />
      ...
      <div>
        ...
        <input
          ...
          placeholder="sam.whitfield@ingrammicro.example"
        />
